    ...
    <AppShell activePath="/chat" className="h-dvh max-w-none gap-0 px-0 pb-0 pt-16 md:h-dvh md:pl-72 md:pr-0 md:pt-20">
      <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px]">
        <section className="relative flex min-h-0 flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-4 pb-56 pt-5 md:px-8 md:pb-8">
            <div className="mx-auto flex max-w-3xl flex-col gap-6">
              <div className="flex flex-col items-center py-5 text-center">
                ...
                <button
                  type="button"
                  className="mt-4 rounded-full border border-satomi-purple/40 bg-satomi-purple/12 px-5 py-2 font-mono text-xs font-semibold tracking-[0.16em] text-satomi-purple-soft"
                >
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {["Makanan", "Transport", "Self-Reward"].map((item) => (
              <button
                key={item}
                type="button"
                className="rounded-full border border-white/10 bg-satomi-surface-high/70 px-3 py-1.5 font-mono text-[11px] text-satomi-muted transition hover:border-satomi-cyan/35 hover:text-satomi-cyan"
              >
                {item}
              </button>
            ))}
    ...
    >
      <div className="mx-auto max-w-md">
        <button
          type="button"
          onClick={onToggle}
          className="mx-auto mb-2 flex items-center gap-2 rounded-full border border-satomi-cyan/30 bg-satomi-surface/90 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.18em] text-satomi-cyan shadow-[0_0_20px_rgba(0,240,255,0.16)]"
        >
          Pratinjau transaksi
          <ChevronDown
